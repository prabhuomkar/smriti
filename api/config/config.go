...
type ( // Log ...
	...
	ML struct {
		...
		OCRParams              string `envconfig:"SMRITI_ML_OCR_PARAMS"               default:"{\"use_doc_orientation_classify\":true,\"doc_orientation_classify_model_name\":\"PP-LCNet_x1_0_doc_ori\",\"doc_orientation_classify_model_dir\":\"ocr_doc_orient/PP-LCNet_x1_0_doc_ori_infer\",\"use_textline_orientation\":true,\"textline_orientation_model_name\":\"PP-LCNet_x0_25_textline_ori\",\"textline_orientation_model_dir\":\"ocr_text_line_orient/PP-LCNet_x0_25_textline_ori_infer\",\"use_doc_unwarping\":true,\"doc_unwarping_model_name\":\"UVDoc\",\"doc_unwarping_model_dir\":\"ocr_text_unwrap/UVDoc_infer\",\"text_detection_model_name\":\"PP-OCRv5_mobile_det\",\"text_detection_model_dir\":\"ocr_text_det/PP-OCRv5_mobile_det_infer\",\"text_recognition_model_name\":\"PP-OCRv5_mobile_rec\",\"text_recognition_model_dir\":\"ocr_text_rec/PP-OCRv5_mobile_rec_infer\"}"` //nolint:lll
		...
		FacesParams            string `envconfig:"SMRITI_ML_FACES_PARAMS"             default:"{\"detection_threshold\":0.8,\"detection_model\":\"faces_det/srcfd_2.5g.onnx\",\"recognition_model\":\"faces_rec/webface_r50.onnx\"}"` //nolint:lll

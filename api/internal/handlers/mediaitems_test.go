	...
	tests := []Test{
		...
		},
		{
			...
			func(mock pgxmock.PgxPoolIface) {
				mock.ExpectQuery(
					regexp.QuoteMeta(
						`SELECT p.*, m.* FROM places p LEFT JOIN mediaitems`,
					),
				).
					WithArgs(
						pgxmock.AnyArg(),
		...
		{
			"get mediaitem places with error in scanning",
			http.MethodGet,
			"/v1/mediaItems/:id/places",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179/places",
			[]string{"id"},
	...
	tests := []Test{
		...
		},
		{
			...
			func(mock pgxmock.PgxPoolIface) {
				mock.ExpectQuery(
					regexp.QuoteMeta(
						`SELECT t.*, m.* FROM things t LEFT JOIN mediaitems`,
					),
				).
					WithArgs(
						pgxmock.AnyArg(),
					...
					WillReturnRows(
						pgxmock.NewRows(append(thingCols, mediaitemCols...)),
					)
			},
			nil,
			nil,
		...
		{
			"get mediaitem things with error in scanning",
			http.MethodGet,
			"/v1/mediaItems/:id/things",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179/things",
			[]string{"id"},
	...
	tests := []Test{
		...
		},
		{
			...
			func(mock pgxmock.PgxPoolIface) {
				mock.ExpectQuery(
					regexp.QuoteMeta(
						`SELECT p.*, mf.* FROM people p LEFT JOIN mediaitem_faces`,
					),
				).
					WithArgs(
						pgxmock.AnyArg(),
		...
		{
			"get mediaitem people with error in scanning",
			http.MethodGet,
			"/v1/mediaItems/:id/people",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179/people",
			[]string{"id"},
	...
	tests := []Test{
		...
		},
		{
			...
			func(mock pgxmock.PgxPoolIface) {
				mock.ExpectQuery(
					regexp.QuoteMeta(
						`SELECT a.*, m.* FROM albums a LEFT JOIN mediaitems`,
					),
				).
					WithArgs(
						pgxmock.AnyArg(),
					...
					WillReturnRows(
						pgxmock.NewRows(append(albumCols, mediaitemCols...)),
					)
			},
			nil,
			nil,
		...
		{
			"get mediaitem albums with error in scanning",
			http.MethodGet,
			"/v1/mediaItems/:id/albums",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179/albums",
			[]string{"id"},
...
func TestGetMediaItem(t *testing.T) {
	tests := []Test{
		...
		{
			"get mediaitem with error in scanning",
			http.MethodGet,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
...
func TestDeleteMediaItem(t *testing.T) {
	tests := []Test{
		...
		{
			"delete mediaitem with error starting transaction",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
		...
		{
			"delete mediaitem with error getting album new cover mediaitems",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
			...
			func(mock pgxmock.PgxPoolIface) {
				...
				mock.ExpectQuery(
					regexp.QuoteMeta(
						`SELECT DISTINCT ON (am.album_id) am.album_id, am.mediaitem_id FROM album_mediaitems`,
					),
				).
					WithArgs(
						pgxmock.AnyArg(),
		...
		{
			"delete mediaitem with error scanning album new cover mediaitems",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
		...
		{
			"delete mediaitem with error getting place new cover mediaitems",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
			...
			func(mock pgxmock.PgxPoolIface) {
				...
				mock.ExpectQuery(
					regexp.QuoteMeta(
						`SELECT DISTINCT ON (pm.place_id) pm.place_id, pm.mediaitem_id FROM place_mediaitems`,
					),
				).
					WithArgs(
						pgxmock.AnyArg(),
		...
		{
			"delete mediaitem with error scanning place new cover mediaitems",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
		...
		{
			"delete mediaitem with error getting thing new cover mediaitems",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
			...
			func(mock pgxmock.PgxPoolIface) {
				...
				mock.ExpectQuery(
					regexp.QuoteMeta(
						`SELECT DISTINCT ON (tm.thing_id) tm.thing_id, tm.mediaitem_id FROM thing_mediaitems`,
					),
				).
					WithArgs(
						pgxmock.AnyArg(),
		...
		{
			"delete mediaitem with error scanning thing new cover mediaitems",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
		...
		{
			"delete mediaitem with error getting people new cover mediaitems",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
			...
			func(mock pgxmock.PgxPoolIface) {
				...
				mock.ExpectQuery(
					regexp.QuoteMeta(
						`SELECT DISTINCT ON (pm.people_id) pm.people_id, pm.mediaitem_id FROM people_mediaitems`,
					),
				).
					WithArgs(
						pgxmock.AnyArg(),
		...
		{
			"delete mediaitem with error scanning people new cover mediaitems",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
		...
		{
			"delete mediaitem with error updating album cover mediaitem",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
		...
		{
			"delete mediaitem with error updating place cover mediaitem",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
		...
		{
			"delete mediaitem with error updating thing cover mediaitem",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
		...
		{
			"delete mediaitem with error updating people cover mediaitem",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
		...
		{
			"delete mediaitem with error committing transaction",
			http.MethodDelete,
			"/v1/mediaItems/:id",
			"/v1/mediaItems/4d05b5f6-17c2-475e-87fe-3fc8b9567179",
			[]string{"id"},
...
func TestGetMediaItems(t *testing.T) {
	tests := []Test{
		...
		{
			"get mediaitems with error in scanning",
			http.MethodGet,
			"/v1/mediaItems",
			"/v1/mediaItems",
			[]string{},

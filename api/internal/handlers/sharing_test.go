...
func TestGetSharedAlbumMediaItems(t *testing.T) {
	tests := []Test{
		{
			"get shared album mediaitems bad request", http.MethodGet, "/v1/sharing/:id/mediaItems", "/v1/sharing/bad-uuid/mediaItems", []string{"id"}, []string{"bad-uuid"}, map[string]string{}, nil, nil, nil, nil, func(handler *Handler) func(ctx echo.Context) error {
				return handler.GetSharedAlbumMediaItems
			}, http.StatusBadRequest, "invalid shared link",
		},
		{
			"get shared album mediaitems not found", http.MethodGet, "/v1/sharing/:id/mediaItems", "/v1/sharing/4d05b5f6-17c2-475e-87fe-3fc8b9567179/mediaItems", []string{"id"}, []string{"4d05b5f6-17c2-475e-87fe-3fc8b9567179"}, map[string]string{}, nil, func(mock pgxmock.PgxPoolIface) {
		...
		{
			"get shared album mediaitems with error", http.MethodGet, "/v1/sharing/:id/mediaItems", "/v1/sharing/4d05b5f6-17c2-475e-87fe-3fc8b9567179/mediaItems", []string{"id"}, []string{"4d05b5f6-17c2-475e-87fe-3fc8b9567179"}, map[string]string{}, nil, func(mock pgxmock.PgxPoolIface) {
				mock.ExpectQuery(regexp.QuoteMeta(`SELECT * FROM mediaitems`)).
					WithArgs(pgxmock.AnyArg(), pgxmock.AnyArg(), pgxmock.AnyArg()).
		...
		{
			"get shared album mediaitems with error in scanning", http.MethodGet, "/v1/sharing/:id/mediaItems", "/v1/sharing/4d05b5f6-17c2-475e-87fe-3fc8b9567179/mediaItems", []string{"id"}, []string{"4d05b5f6-17c2-475e-87fe-3fc8b9567179"}, map[string]string{}, nil, func(mock pgxmock.PgxPoolIface) {
				mock.ExpectQuery(regexp.QuoteMeta(`SELECT * FROM mediaitems`)).
					WithArgs(pgxmock.AnyArg(), pgxmock.AnyArg(), pgxmock.AnyArg()).
		...
		{
			"get shared album mediaitems with 2 rows", http.MethodGet, "/v1/sharing/:id/mediaItems", "/v1/sharing/4d05b5f6-17c2-475e-87fe-3fc8b9567179/mediaItems", []string{"id"}, []string{"4d05b5f6-17c2-475e-87fe-3fc8b9567179"}, map[string]string{}, nil, func(mock pgxmock.PgxPoolIface) {
				mock.ExpectQuery(regexp.QuoteMeta(`SELECT * FROM mediaitems`)).
					WithArgs(pgxmock.AnyArg(), pgxmock.AnyArg(), pgxmock.AnyArg()).
...
func TestGetSharedAlbum(t *testing.T) {
	tests := []Test{
		{
			"get shared album bad request", http.MethodGet, "/v1/sharing/:id", "/v1/sharing/bad-uuid", []string{"id"}, []string{"bad-uuid"}, map[string]string{}, nil, nil, nil, nil, func(handler *Handler) func(ctx echo.Context) error {

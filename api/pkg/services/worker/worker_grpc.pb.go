...
const (
	Worker_MediaItemProcess_FullMethodName  = "/Worker/MediaItemProcess"
	Worker_GenerateEmbedding_FullMethodName = "/Worker/GenerateEmbedding"
)
...
func (c *workerClient) MediaItemProcess(ctx context.Context, in *MediaItemProcessRequest, opts ...grpc.CallOption) (*MediaItemProcessResponse, error) {
	...
	err := c.cc.Invoke(ctx, Worker_MediaItemProcess_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workerClient) GenerateEmbedding(ctx context.Context, in *GenerateEmbeddingRequest, opts ...grpc.CallOption) (*GenerateEmbeddingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateEmbeddingResponse)
	err := c.cc.Invoke(ctx, Worker_GenerateEmbedding_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWorkerServer) GenerateEmbedding(context.Context, *GenerateEmbeddingRequest) (*GenerateEmbeddingResponse, error) {
...
func _Worker_MediaItemProcess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Worker_MediaItemProcess_FullMethodName,
	}
...
func _Worker_GenerateEmbedding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {

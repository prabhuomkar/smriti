...
func (m *Minio) Upload(filePath, fileType, fileID string) (string, error) {
	...
	objectOptions := minio.PutObjectOptions{ContentType: contentType}
...
func (m *Minio) Get(fileType, fileID string) (string, error) {
	presignedURL, err := m.Client.PresignedGetObject(context.Background(), fileType, fileID, expiryTime*time.Hour, url.Values{})
	if err != nil {

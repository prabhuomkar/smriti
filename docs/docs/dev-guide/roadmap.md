...
- [ ] Faster Worker using C++ (v2026.01.31)
- [ ] Improved Video Support C++ (v2026.02.28)
- [ ] UI Features except Home and Search (v2026.02.28)
- [ ] Sync content from other providers: Apple iCloud, Google Photos (v2026.03.31)
- [ ] Generation of Memories (v2026.04.30)

...
COMMON_RESULT = {'locality': 'Dombivli', 'area': 'Ayre Road', 'postcode': '421201', 'country': 'India'}
...
async def test_places_process_success(_, __):
    ...
    assert result == {'keywords': '421201 india dombivli ayre road', 'latitude': 19.2195856, 'longitude': 73.1056888}
...
async def test_places_process_success_with_keywords(_, __):
    ...
    assert result == {'keywords': 'exists 421201 india dombivli ayre road', 'latitude': 19.2195856, 'longitude': 73.1056888}
...
@mock.patch('src.providers.places.OpenStreetMap.reverse_geocode', return_value=COMMON_RESULT)
@pytest.mark.asyncio
async def test_places_process_grpc_exception(_):

...
# create user
res = requests.post(f"{API_URL}/v1/users",
                    auth=("smriti", "smritiT3st!"),
                    json={"name":"Jeff Dean","username":"jeffdean","password":"jeffT3st!",
                          "features":"{\"albums\":true,\"favourites\":true,\"hidden\":true,"+
                          "\"trash\":true,\"explore\":true,\"places\":true,\"people\":true,\"sharing\":true}"})

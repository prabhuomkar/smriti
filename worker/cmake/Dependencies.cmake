...
function(fetch_onnxruntime TAG)
    ...
    find_library(ONNXRUNTIME_LIBRARIES onnxruntime PATHS ${ONNXRUNTIME_LIB})
...
function(fetch_paddle_inference_and_deps)
    ...
    set(PADDLE_INFERENCE_LIB ${PADDLE_INFERENCE_DIR}/paddle/lib PARENT_SCOPE)
    find_library(PADDLE_INFERENCE_LIBRARIES paddle_inference PATHS ${PADDLE_INFERENCE_LIB})
    set(PADDLE_INFERENCE_LIBRARIES ${PADDLE_INFERENCE_LIBRARIES} PARENT_SCOPE)
endfunction()

...
function(fetch_paddle_inference_and_deps)
    if(APPLE)
        ...
        set(PADDLE_INFERENCE_EXTRACTED_DIR_NAME "paddle_inference_install_dir")
    elseif(UNIX)
        if(CMAKE_SYSTEM_PROCESSOR STREQUAL "arm64")
        ...
        set(PADDLE_INFERENCE_EXTRACTED_DIR_NAME "paddle_inference")
    endif()
    ...
    if(NOT EXISTS ${PADDLE_INFERENCE_DIR})
        ...
        file(RENAME "${FETCHCONTENT_BASE_DIR}/${PADDLE_INFERENCE_EXTRACTED_DIR_NAME}" ${PADDLE_INFERENCE_DIR})
    endif()

...
class MediaItemMetadataRequest(_message.Message):
    __slots__ = ["userId", "id", "status", "mimeType", "sourcePath", "previewPath", "thumbnailPath", "type", "category", "width", "height", "creationTime", "cameraMake", "cameraModel", "focalLength", "apertureFNumber", "isoEquivalent", "exposureTime", "fps", "latitude", "longitude"]
...
class MediaItemFacesRequest(_message.Message):
    __slots__ = ["userId", "id", "embeddings"]
    USERID_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
